            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{route('show.blog')}}">Blog All</a>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 py-100">
                    <div class="border rounded bg-white">
                        ...
                        <div class="p-4">
                            <h3>{{$blog->title}}: Why To Online</h3>
                            @php
                            ...
                            <ul class="list-inline d-block pb-4 border-bottom mb-3">
                                ...
                                <li class="list-inline-item text-color">Published On {{\Illuminate\Support\Carbon::parse($blog->created_at)->diffForHumans()}}</li>
                                <li class="list-inline-item text-color">Tag: {{$blog->category->category_name}}</li>
                            </ul>
                                ...
                                <div>
                                    <ul class="d-inline-block pl-0 float-sm-left mr-sm-5">
                                        ...
                                        <li class="font-secondary mb-10">
                                            <i class="text-primary mr-2 ti-arrow-circle-right"></i>{{$blog->category->category_name}}</li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>

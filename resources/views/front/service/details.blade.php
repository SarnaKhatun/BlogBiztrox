            ...
            <div class="row">
                ...
                <aside class="col-lg-4 order-lg-1 order-2">
                    ...
                    <ul class="service-menu pl-0 border rounded mb-50">
                        ...
                        <li class="active border-bottom">
                            <a class="d-block font-primary text-dark p-4 rounded-top" href="{{route('show.service')}}">{{$service->category->category_name}}</a>
                        </li>
                        @endforeach
                    </ul>
                    <!-- Brochure -->
                ...
                <div class="col-lg-8 order-lg-2 ">
                    ...
                    <div class="bg-gray p-5 rounded mb-60">
                        <p class="text-dark font-primary mb-30">{!! $service->description !!}</p>
                        <div>
